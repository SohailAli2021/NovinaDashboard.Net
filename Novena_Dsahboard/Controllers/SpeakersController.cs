...
namespace Novena_Dsahboard.Controllers
{
    public class SpeakersController : Controller
    {
        ...
        public SpeakersController(Novena_DsahboardContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Title,Picture,Decsription")] Speaker speaker)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Title,Picture,Decsription")] Speaker speaker)
        {
            if (id != speaker.Id)
            {
                return NotFound();
